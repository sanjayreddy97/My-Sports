 ...
 */
package edu.iit.itmd4515.smuthyala.lab3;
...
public class Staff{
    ...
    private Integer addressId,storeId;
    ...
    public String toString() {
        return "Staff{" + "active=" + active + ", addressId=" + addressId + ", email=" + email + ", lastName=" + lastName + ", firstName=" + firstName + ", storeId=" + storeId + ", staffid=" + Id + '}';
    }
}
